...
class Lang {
	...
	protected $data = [
		'ru'	=> [
			...
			self::CLOSE => 'Закрыть',
			self::AGREEMENT => 'Я даю согласие на обработку своих<br/><a href="/privacy-policy/" target="_blank">персональных данных</a>',
			self::SEND => 'Отправить',
		...
		'en'	=> [
			...
			self::CLOSE => 'Close',
			self::AGREEMENT => 'I agree to my <br/><a href="/privacy-policy/" target="_blank">personal data</a> being processed',
			self::SEND => 'Submit',
			self::SHARE => 'Share',
		...
		'cz'	=> [
			...
			self::CLOSE => 'Zavřít',
			self::AGREEMENT => 'Souhlasím se <br/><a href="/privacy-policy/" target="_blank">zpracováním</a> osobních údajů',
			self::SEND => 'Odeslat',
			self::SHARE => 'Sdílet',
